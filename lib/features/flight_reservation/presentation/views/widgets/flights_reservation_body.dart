...
class AddressRow7 extends StatelessWidget {
  const AddressRow7({Key? key, required this.flightReservations}) : super(key: key);
  final List<FlightReservation> flightReservations;

  @override
  Widget build(BuildContext context) {
    return SizedBox(
      // height: 50.0 * (hotels.length+1) +(20*hotels.length+1),
        width: MediaQuery.of(context).size.width-350 < 110*15 ? 110*15 :  MediaQuery.of(context).size.width-350,
            ...
            children: [
              const Row(
                ...
                [
                  ...
                  HotelItemTextBuilder(text: 'Return From', isHeader: true,),
                  HotelItemTextBuilder(text: 'Return To', isHeader: true,),
    ...
    return Container(
      ...
      child: Row(
        ...
        [
          ...
          HotelItemTextBuilder(text: hotel.returnFrom),
          HotelItemTextBuilder(text: hotel.returnTo),
          ...
          SizedBox(
            width: (MediaQuery.of(context).size.width-350)/15 <110 ?110 :(MediaQuery.of(context).size.width-350)/15,
            child: Column(
...
class HotelItemTextBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        width:  (MediaQuery.of(context).size.width-300)/15 <100 ? 110 : (MediaQuery.of(context).size.width-300)/15,
        child: Text(
          text,
          style: isHeader ?
