...
class AddNewAirport extends StatefulWidget {
  const AddNewAirport({Key? key}) : super(key: key);

  @override
  State<AddNewAirport> createState() => _AddNewAirportState();
}


class _AddNewAirportState extends State<AddNewAirport> {
          ...
          child: Column(
            ...
            [
              Column(
                ...
                children: [
                  const Text('Add New Airport',style:TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 20,),
                  FieldBuilder(text: 'Airport Name', controller: TextEditingController(), ),
                  const SizedBox(height: 20,),
                  FieldBuilder(text: 'Airport Name English', controller: TextEditingController()),
