...
import '../localization/translation_key_manager.dart';
    ...
    return SizedBox(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          hintText: hint,
          errorStyle: StyleManager.bookInputField.copyWith(color: ColorsManager.tabBarIndicator),
          filled: true,
          ...
          OutlineInputBorder(
              ...
              borderSide:  BorderSide(
                color: enabled ? Colors.grey.withOpacity(0.2): Colors.transparent,
              )
          ),
